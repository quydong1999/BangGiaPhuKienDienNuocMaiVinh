...
export default function GoogleMap() {
  ...
  return (
    <div ref={containerRef} className="overflow-hidden w-full h-44 border border-teal-400/30 shadow-lg bg-teal-800/20 flex items-center justify-center">
      {shouldLoad ? (
        <iframe
        ...
        <div className="text-teal-200/50 text-xs animate-pulse">
          Đang tải bản đồ...
        </div>
      )}
    </div>
